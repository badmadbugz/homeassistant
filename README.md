...
|---------------------|-----------|---|-----|---------|-----------|----------|
| Кормушка: граммов при засыпке | `input_number.kormushka_refill_grams` | 0 | 2000 | g | 500 | Сколько граммов насыпано при последней дозахватке. Задаётся вручную после каждой засыпки (или с карточки дашборда). Используется в формуле остатка: остаток = засыпка − выдано. |
...
| Кормушка: съедено за месяц | `input_number.kormushka_total_month` | 0 | 100000 | g | 0 | Статистика: граммов за месяц. Сбрасывается 1-го числа. |
| Кормушка: съедено за год | `input_number.kormushka_total_year` | 0 | 500000 | g | 0 | Статистика: граммов за год. Сбрасывается 1 января. |
...
5. Задать начальное значение «граммов при засыпке», добавить карточки на дашборд.
